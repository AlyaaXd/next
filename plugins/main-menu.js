 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya DityaBotz ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 DityaBotz..."},
	]
    },{
...
const listMessage = {
  text: tek,
  footer: '© DityaAstawa | ALL RESERVED',
...
//-------DOC TEMPLATE
    ...
    document: { url: thumbdoc },
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By Dityaastawa',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https:/wa.me/6285237596750'
                    }
                },
                {
                    urlButton: {
